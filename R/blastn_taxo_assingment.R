...
#' to assign taxonomy. If blastn and megablast were both chosen, it merges the results
...
#' taxonomic assignments. Megablast and especially blastn can take several hours
